...
__all__ = ["train_loader", "test_loader", "image_transform", 'dsetname', 'dsetnclasses']

dsetname = "CIFAR10"
dsetnclasses = 10

dsetbase = Path("local_datasets/cifar10")
...
if not Path(dsetbase / "processed.pt").exists():
    ...
    trainset = torchvision.datasets.CIFAR10(root=dsetbase, train=True, download=True, transform=transform)
    testset = torchvision.datasets.CIFAR10(root=dsetbase, train=False, download=True, transform=transform)
